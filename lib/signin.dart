       ...
       child: Padding(
          ...
          child: Form(
            ...
            TextButton(
              ...
              child: const Text('Forgot Password?',style: TextStyle(fontSize: 18,color: Colors.blue),),
            ),
            SizedBox(height: 1.0),
            TextButton(
              onPressed: () {
              ...
              child: const Text('Don\'t have an account? Sign Up',style: TextStyle(fontSize: 18,color: Colors.blue),),
            ),
